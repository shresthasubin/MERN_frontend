...
const DepartmentManager = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingId) {
                await publicAPI.put(`/department/All/update/${editingId}`, formData)
            } else {
                await publicAPI.post(`/department/All/create`,formData)
            }
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await publicAPI.delete(`/department/All/delete/${id}`);
      fetchDepartments();
